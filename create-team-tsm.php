	   ...
	   <!-----ddddddd--------->
	    <div class="container" >
			...
			<form method="POST" action="" name="create_team" id="create-team">
					...
					<input type="hidden" id="distributerid"  name="distributerid" value="<?php echo $_SESSION['userData']['distributerId']
;?>" class="form-control">
					...
					<div class="col-md-12" style="overflow:hidden;">
						<button type="button" class="add-btn new-btn" id="manager_team">Submit</button>
					</div>
					</form>
				</div>
...
$('#role').on('change', function () {
	...
	if(roleid!=''){
			$.ajax({
				type: "POST",
				url: 'ajax.php',
				data: 'roleid='+roleid+'&distributerid='+distributerId+'&page=getAsmteam',
