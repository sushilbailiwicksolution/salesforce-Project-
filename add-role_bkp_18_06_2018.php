<?php
  ...
  <div class="content-wrapper">
	...
	$url="http://103.206.248.235:8080/salesforceapi/getRole";
	$header=
	array(
  ...
  <table class="table table-hover table-fixed" style="border:1px solid #ddd; font-size:12px;" id="get_role" name="get-role">
    ...
    <tbody>
	    ...
	    <tr>		
			...
			<td class="col-md-3"> 
			<button type="button" class="btn btn-primary small-btn" name="manager-edit" id="manager_edit"><i class="fa fa-pencil" aria-hidden="true"></i></button>
