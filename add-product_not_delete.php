	...
	if(!empty($proID)){
		...
		<div class="row abc">				
			...
			<input type="hidden" id="updateid"  name="updateid" value="1" class="form-control">
				...
				<select class="form-control" name="bran_name" id="bran_name">
...
$('#brand_name').on('change', function () {
	...
	if(brandid!=''){
			...
			<div class="col-sm-2">
				...
				<select class="form-control" name="bran_code" id="bran_code">

						<option>Select</option>							

							<?php if(isset($_POST['bran_name'])){
...
$('#brand_code').on('change', function () {
	...
	if(brand_code!=''){
			...
			<div class="col-sm-2">
				...
				<select class="form-control" name="interna_brand_code" id="interna_brand_code">
...
$('#internal_brand_code').on('change', function () {
	...
	if(internal_brand_code!=''){
			...
			<div class="col-sm-2">
				...
				<input type="text" id="produc_code" name="produc_code" class="form-control" value="<?php echo $productData->productCode;?>">
			...
			<div class="col-sm-2">
				...
				<select class="form-control" id="number" name="number">
					...
					<?php if(isset($_POST['qty'])){?>
						...
						<option value="<?php echo $value->id; ?>" <?php if($productData->qtyInpcsValue==$value->pcs){echo 'selected'; } ?>><?php echo $value->pcs; ?></option>	
	   ...
	   ?> 	   
			...
			<div class="col-sm-2">
				...
				<label for="defaultFormLoginEmailEx" class="grey-text">License</label>
					...
					<select class="form-control" name="licens" id="licens">
	...
	<script>
		...
		$(document).ready(function(){
			...
			$("#add_product").click(function(){
				...
				$( "#bran_name" ).prop( "disabled", true );

				$( "#bran_code" ).prop( "disabled", true );

				$( "#interna_brand_code" ).prop( "disabled", true );

				$( "#produc_code" ).prop( "disabled", true );

				$( "#licens" ).prop( "disabled", true );
			...
			$("#update_product").click(function(){
				...
				var product_code=$('#produc_code').val();
